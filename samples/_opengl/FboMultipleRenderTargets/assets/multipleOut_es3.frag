...
void main()
{
	...
	vec3 colorAttachment1 = vec3( 0, 1, 0 );
	vec3 colorAttachment2 = vec3( 0, 0, 1 );
	vec3 colorAttachment3 = vec3( 1, 1, 1 );
	...
	colorAttachment2 *= lambert;
	colorAttachment3 *= lambert;

	oFragColor0 = vec4( colorAttachment0, 1.0 );
	oFragColor1 = vec4( colorAttachment1, 1.0 );
	oFragColor2 = vec4( colorAttachment2, 1.0 );
	oFragColor3 = vec4( colorAttachment3, 1.0 );
}
